...
# adding img and labels in the main window
upload = Image.open("app_img2.jpg")
# resize the img using resize() method
...
def msg():
    MsgBox = messagebox.showinfo(
        "Alert", "Do you want to calculate the denominaton count?")
    if MsgBox == 'ok':
        topwin()
